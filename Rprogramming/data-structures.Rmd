...
```
##### Classes 
R being an object oriented language contains Objects. Objects are instances of classes. Most common and foundational in R are the S3 class objects, which are also kown as lists. 
